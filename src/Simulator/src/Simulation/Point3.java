...
public class Point3 {
    ...
    public static final Point3 zero() {
        return new Point3(0, 0, 0);
    }
    public static final Point3 one() {
        return new Point3(1, 1, 1);
    }
    public static final Point3 up() {
        return new Point3(0, 1, 0);
    }
    public static final Point3 down() {
        return new Point3(0, -1, 0);
    }
    public static final Point3 left() {
        return new Point3(-1, 0, 0);
    }
    public static final Point3 right() {
        return new Point3(1, 0, 0);
    }
    public static final Point3 forward() {
        return new Point3(0, 0, 1);
    }
    public static final Point3 backward() {
        return new Point3(0, 0, -1);
    }
